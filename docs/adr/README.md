...
ADRs capture significant technical choices. New ADRs increment the number and stay **immutable** once accepted; supersede with a new ADR if the decision changes.

| ID | Status | Title |
|----|--------|-------|
| [001](001-pgvector-in-postgres.md) | Accepted | pgvector in PostgreSQL |
